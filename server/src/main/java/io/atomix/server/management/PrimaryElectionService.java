...
public interface PrimaryElectionService {
  ...
  /**
   * Returns the election for the given partition.
   *
   * @param partitionId the partition for which to return the election
   * @return the election for the given partition
   */
