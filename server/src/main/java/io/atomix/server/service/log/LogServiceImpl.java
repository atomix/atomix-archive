 ...
 */
package io.atomix.server.service.log;
...
public class LogServiceImpl extends LogServiceGrpc.LogServiceImplBase {
  ...
  public LogServiceImpl(LogProtocol protocol) {
    this.client = protocol.getLogClient();
  }
  ...
  public void consume(ConsumeRequest request, StreamObserver<LogRecord> responseObserver) {
    Consumer<io.atomix.service.protocol.LogRecord> consumer = record -> {
