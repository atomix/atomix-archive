 ...
 * <ul>
 *   <li>{@link #broadcast(String, Object, Function)} broadcasts a message to all cluster members</li>
 *   <li>{@link #multicast(String, Object, Function, Set)} sends the message to all provided members</li>
 *   <li>{@link #unicast(String, Object, Function, MemberId)} sends a unicast message directly to the given member</li>
 *   <li>{@link #send(String, Object, Function, Function, MemberId)} sends a message directly to the given member and awaits a reply</li>
 * </ul>
 * To register to listen for messages, use one of the {@link #subscribe(String, Function, Consumer, Executor)} methods:
 * <pre>
 *   {@code
