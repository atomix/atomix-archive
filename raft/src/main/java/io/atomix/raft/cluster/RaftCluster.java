 ...
 * cluster by calling {@link RaftServer#bootstrap(String...)}  or {@link #join(String...)},
...
public interface RaftCluster {
   ...
   */
  RaftMember getMember(String id);
   ...
   */
  default CompletableFuture<Void> bootstrap(String... cluster) {
   ...
   * @return A completable future to be completed once the cluster has been bootstrapped.
   */
  CompletableFuture<Void> bootstrap(Collection<String> cluster);
   ...
   */
  default CompletableFuture<Void> listen(String... cluster) {
   ...
   * @return A completable future to be completed once the local server has joined the cluster.
   */
  CompletableFuture<Void> listen(Collection<String> cluster);
   ...
   * @return A completable future to be completed once the local server has joined the cluster.
   */
  default CompletableFuture<Void> join(String... cluster) {
    return join(Arrays.asList(cluster));
  }
   ...
   * @return A completable future to be completed once the local server has joined the cluster.
   */
  CompletableFuture<Void> join(Collection<String> cluster);
   ...
   * <p>
   * When a server leaves the cluster, the server submits a {@link io.atomix.raft.protocol.LeaveRequest}
