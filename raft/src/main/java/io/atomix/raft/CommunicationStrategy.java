...
public enum CommunicationStrategy {
  ...
  ANY {
    @Override
    public List<String> selectConnections(String leader, List<String> members) {
   ...
   * <p>
   * The client will iterate the provided {@link String} list in order, attempting to connect to
   ...
   */
  public abstract List<String> selectConnections(String leader, List<String> members);
