...
public class RaftContext implements AutoCloseable {
  ...
  private final RaftStateMachineManager stateMachine;
  ...
  public RaftContext(
    ...
    this.stateMachine = new RaftStateMachineManager(this, stateMachine, stateContext);

    this.cluster = new RaftClusterContext(localServerId, this);
   ...
   */
  public void setLastVotedFor(String candidate) {
   ...
   */
  public RaftStateMachineManager getServiceManager() {
    return stateMachine;
  }
