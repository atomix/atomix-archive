...
public class TestRaftProtocolFactory {
  private final Map<String, TestRaftServerProtocol> servers = Maps.newConcurrentMap();
  ...
  public RaftClientProtocol newClientProtocol() {
    return new TestRaftClientProtocol(servers, context);
  }
   ...
   */
  public RaftServerProtocol newServerProtocol(String memberId) {
    return new TestRaftServerProtocol(memberId, servers, context);
  }
}
