...
import io.atomix.grpc.election.CloseRequest;
import io.atomix.grpc.election.CloseResponse;
...
import io.atomix.grpc.election.EventRequest;
import io.atomix.grpc.election.EventResponse;
...
import io.atomix.grpc.election.KeepAliveRequest;
import io.atomix.grpc.election.KeepAliveResponse;
...
public class LeaderElectionServiceImpl extends LeaderElectionServiceGrpc.LeaderElectionServiceImplBase {
  ...
  public LeaderElectionServiceImpl(Atomix atomix) {
    this.primitiveFactory = new PrimitiveFactory<>(atomix, LeaderElectionService.TYPE, (id, client) -> new LeaderElectionProxy(new DefaultSessionClient(id, client)), ELECTION_ID_DESCRIPTOR);
