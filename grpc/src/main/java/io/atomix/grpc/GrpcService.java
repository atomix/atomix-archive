 ...
 */
package io.atomix.grpc;

import io.atomix.core.Atomix;
import io.atomix.grpc.impl.NettyGrpcService;
...
public interface GrpcService {
  ...
  static Builder builder() {
    return new NettyGrpcService.Builder();
  }
   ...
   */
  abstract class Builder implements io.atomix.utils.Builder<ManagedGrpcService> {
