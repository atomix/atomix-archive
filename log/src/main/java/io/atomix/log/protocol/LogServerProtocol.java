...
public interface LogServerProtocol {
   ...
   * @param consumerId the consumer to which to send the request
   * @param request the request to send
   */
  void produce(String memberId, long consumerId, RecordsRequest request);
   ...
   */
  CompletableFuture<BackupResponse> backup(String memberId, BackupRequest request);
