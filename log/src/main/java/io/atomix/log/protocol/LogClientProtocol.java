...
public interface LogClientProtocol {
   ...
   * @return a future to be completed with the response
   */
  CompletableFuture<ConsumeResponse> consume(String memberId, ConsumeRequest request);
   ...
   */
  void registerRecordsConsumer(long consumerId, Consumer<RecordsRequest> handler, Executor executor);
   ...
   * @param consumerId the consumer ID
   */
  void unregisterRecordsConsumer(long consumerId);
