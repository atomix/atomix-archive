 ...
 */
public interface RaftClient extends ProtocolClient {
   ...
   */
  @Override
  default CompletableFuture<byte[]> query(byte[] value) {
    return query(value, ReadConsistency.LINEARIZABLE);
  }
   ...
   * @return a future to be completed with the result
   */
  CompletableFuture<byte[]> query(byte[] value, ReadConsistency consistency);
   ...
   */
  @Override
  default CompletableFuture<Void> query(byte[] value, StreamHandler<byte[]> handler) {
    return query(value, ReadConsistency.LINEARIZABLE, handler);
  }
   ...
   * @return a future to be completed with the result
   */
  CompletableFuture<Void> query(byte[] value, ReadConsistency consistency, StreamHandler<byte[]> handler);
