...
/**
 * Atomic map configuration test.
 */
public class AtomicMapConfigTest {
  @Test
  public void testLoadConfig() throws Exception {
    AtomicMapConfig config = Atomix.config(getClass().getClassLoader().getResource("primitives.conf").getPath())
        .getPrimitive("atomic-map");
    assertEquals("atomic-map", config.getName());
