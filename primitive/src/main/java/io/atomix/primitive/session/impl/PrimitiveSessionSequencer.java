...
final class PrimitiveSessionSequencer {
  ...
  PrimitiveSessionSequencer(PrimitiveSessionState state) {
    this.state = state;
   ...
   */
  public void sequenceEvent(EventRequest request, Runnable callback) {
  ...
  private static final class EventCallback implements Runnable {
    ...
    private EventCallback(EventRequest request, Runnable callback) {
